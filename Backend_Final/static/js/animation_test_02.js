...
$(document).ready(function () {
    ...
    rotator_container = document.getElementById('container-all');
    rotator_container.addEventListener('scroll', onScroll, false);
});
...
function onScroll(event) {
    ...
    if (rotator_container.scrollTop > scrollPos) {
        camera_pivot.rotation.y -= 0.004;
    } else {
        camera_pivot.rotation.y += 0.004;
    }

    scrollPos = rotator_container.scrollTop;
}
